      ...
      <div className="container mx-auto px-4 py-16 flex items-center justify-center">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-lg bg-gradient-to-br from-orange-400 to-pink-500 mx-auto mb-4">
              <span className="text-3xl font-bold text-white">MC</span>
            </div>
            <CardTitle className="text-2xl">Create Your Account</CardTitle>
            <CardDescription>
              Join Mentor Connect and start your journey
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="mentor" className="font-normal cursor-pointer">
                      Mentor - I want to help others grow
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="both" id="both" />
                    <Label htmlFor="both" className="font-normal cursor-pointer">
                      Both - I want to learn and mentor
                    </Label>
                  </div>
                </RadioGroup>
              </div>
